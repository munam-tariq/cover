          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg">{t("setupProgress")}</CardTitle>
              </div>
              <span className="text-sm font-medium text-primary">
                {t("setupProgressCount", {
                  completed: onboarding.progress.completed,
        ...
        <Card className="border-green-200 bg-green-50/50">
          <CardContent className="py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-green-800">{t("setupCompleteTitle")}</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/playground">
          <Card className="hover:border-primary/50 transition-colors cursor-pointer h-full">
            <CardHeader>
              <CardTitle className="text-lg">{t("quickActions.testTitle")}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                {t("quickActions.testDescription")}
              </p>
            </CardContent>
          </Card>
        </Link>
