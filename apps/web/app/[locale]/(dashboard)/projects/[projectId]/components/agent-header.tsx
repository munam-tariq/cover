...
import { Button, Input, Switch, Label } from "@chatbot/ui";
...
export function AgentHeader({ project }: AgentHeaderProps) {
  ...
  return (
    <div className="flex flex-col gap-4 pb-4 border-b md:flex-row md:items-start md:justify-between">
