...
const FILTER_TABS = [
  ...
  { key: "qualified", labelKey: "qualified" },
  { key: "not_qualified", labelKey: "not_qualified" },
  { key: "qualifying", labelKey: "qualifying" },
];
      ...
      <div className="px-4 pt-4 pb-2 space-y-3 border-b">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full ps-9 pe-3 py-1.5 border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
      </div>
