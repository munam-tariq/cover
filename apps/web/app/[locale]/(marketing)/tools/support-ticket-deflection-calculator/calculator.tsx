...
export function SupportDeflectionCalculator() {
  const t = useTranslations("marketing.calculators.deflection.ui");
  const fieldCopy = t.raw("fields") as { label: string; suffix: string }[];
  ...
  const fields = [
    {
      label: fieldCopy[0].label,
      value: monthlyTickets,
      min: 25,
      max: 10000,
      step: 25,
      suffix: fieldCopy[0].suffix,
      onChange: setMonthlyTickets,
    },
    {
      label: fieldCopy[1].label,
      value: repetitivePercent,
      min: 10,
      max: 95,
      step: 1,
      suffix: fieldCopy[1].suffix,
      onChange: setRepetitivePercent,
    },
    {
      label: fieldCopy[2].label,
      value: deflectionPercent,
      min: 10,
      max: 90,
      step: 1,
      suffix: fieldCopy[2].suffix,
      onChange: setDeflectionPercent,
    },
    {
      label: fieldCopy[3].label,
      value: minutesPerTicket,
      min: 1,
      max: 45,
      step: 1,
      suffix: fieldCopy[3].suffix,
      onChange: setMinutesPerTicket,
    },
    {
      label: fieldCopy[4].label,
      value: hourlyCost,
      min: 10,
      max: 150,
      step: 1,
      suffix: fieldCopy[4].suffix,
