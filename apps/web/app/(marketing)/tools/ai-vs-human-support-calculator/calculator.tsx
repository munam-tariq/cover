...
export function AiVsHumanCalculator() {
  ...
  const sliders = [
    { label: "Monthly support tickets", value: monthlyTickets, min: 50, max: 10000, step: 50, fmt: (v: number) => `${v.toLocaleString()} tickets`, set: setMonthlyTickets },
    { label: "Avg handle time per ticket", value: handleMinutes, min: 2, max: 45, step: 1, fmt: (v: number) => `${v} min`, set: setHandleMinutes },
    { label: "Agent loaded annual salary", value: annualSalary, min: 30000, max: 120000, step: 5000, fmt: (v: number) => money(v), set: setAnnualSalary },
    { label: "Monthly AI tool cost", value: aiMonthlyCost, min: 0, max: 500, step: 1, fmt: (v: number) => `${money(v)}/mo`, set: setAiMonthlyCost },
  ];
  ...
  return (
    <section
      aria-label="AI vs human support cost comparison calculator"
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 24 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "var(--ff-muted)" }}>
              Enter your numbers to see the monthly cost difference.
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "var(--ff-soft)" }}>Human team</span>
          </div>
          <div
            style={{
          ...
          <div style={{ fontSize: 13, color: "var(--ff-muted)", marginTop: 6 }}>per month</div>
          <div
            style={{
              marginTop: 16,
              padding: "10px 14px",
          ...
          >
            {result.agentsNeeded} agent{result.agentsNeeded !== 1 ? "s" : ""} × {money(annualSalary)}/yr salary
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "var(--ff-soft)" }}>AI agent</span>
          </div>
          <div
            style={{
              fontSize: "clamp(28px,4vw,40px)",
          ...
          >
            Flat monthly cost · unlimited conversations
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,.55)", marginTop: 6 }}>
            {aiWins ? "saved with AI vs. human team" : "AI costs more at this volume"}
          </div>
        </div>
        <div style={{ position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,.55)", marginTop: 6 }}>
            tickets/month where AI pays off
          </div>
        </div>
      </div>
    </section>
